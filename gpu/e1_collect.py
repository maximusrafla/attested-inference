...
def main():
    ...
    summary = {
        ...
        "relationship_to_the_published_numbers": (
            "These figures sit ALONGSIDE the earlier ones rather than replacing them. The earlier "
            "roughly 6 percent and roughly 19 percent widths remain correct for the adversary they "
            "were measured against, which is the one that never reacts, and must now be quoted "
            "with that qualifier. The adaptive figures answer a different question."
        ),
